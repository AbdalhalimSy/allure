                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 space-y-1">
                      ...
                      {/* CTA badge */}
                      <div className="inline-flex float-end items-center gap-2 rounded-full px-3 py-1.5 text-xs font-semibold text-primary transition group-hover:bg-[rgba(196,154,71,0.18)] ">
                        {cta}
