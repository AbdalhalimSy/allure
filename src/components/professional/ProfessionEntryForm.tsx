    ...
    <div className="rounded-2xl border border-gray-200 bg-white shadow-sm ring-1 ring-black/5 ">
      ...
      >
        ...
        {(requiresPhoto || requiresVideo || requiresAudio) && (
          <div className="space-y-3 sm:space-y-4 px-3 sm:px-5 py-4 sm:py-5">
            ...
            <div className="grid gap-2 sm:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2">
              {requiresPhoto && (
                <div className="rounded-xl border border-gray-200 bg-white/70 p-3 sm:p-4 ">
