...
export default function AuthShell({
  ...
  return (
 <section className="relative isolate flex min-h-[calc(100vh-160px)] items-center justify-center overflow-hidden bg-linear-to-br from-gray-50 via-white to-gray-100 px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 w-full max-w-lg">
        <SurfaceCard
          accent={accent}
          padding="p-10"
 backgroundClassName="border border-white/40 bg-white/90 shadow-2xl "
