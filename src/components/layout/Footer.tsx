...
export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-[#c49a47]/30 bg-gray-50 py-8 shadow-inner dark:border-[#c49a47]/20 dark:bg-gray-950">
      <div className="container mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col items-center gap-6">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            &copy; <span suppressHydrationWarning>{CURRENT_YEAR}</span> Allure Casting Platform. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
