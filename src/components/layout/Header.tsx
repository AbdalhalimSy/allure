      ...
      <>
        ...
        >
          <div className="flex h-full flex-col" suppressHydrationWarning>
            {/* Header */}
            <div
              className="flex items-center justify-between border-b border-gray-200 px-6 py-4 dark:border-white/10"
              suppressHydrationWarning
            >
              <Link
                href="/"
            ...
            {isAuthenticated && (
              <div
                className="border-b border-gray-200 p-6 dark:border-white/10"
                suppressHydrationWarning
              >
            ...
            {/* Footer Actions */}
            <div
              className="border-t border-gray-200 p-6 dark:border-white/10"
              suppressHydrationWarning
            >
              <div
